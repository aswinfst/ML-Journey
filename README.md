...
#### Prerequisites
- [x] **Basic Algebra**: Understand variables, equations, graphs, and functions.
  - **Resources**:
...
- [x] **Basic Programming Skills**: Familiarity with programming, especially in Python.
  - **Resources**:
    - [Codecademy: Python](https://www.codecademy.com/learn/learn-python-3)
    - [Real Python: Python Basics](https://realpython.com/start-here/)
  - **Completed**: Practiced Python programming with small projects and exercises.

- [x] **Statistics and Probability**: Basic understanding of statistics and probability.
  - **Resources**:
    - [Khan Academy: Probability and Statistics](https://www.khanacademy.org/math/statistics-probability)
    - [StatQuest: Statistics with Josh Starmer](https://statquest.org/)
